  ...
  return (
    <main className="flex flex-col lg:flex-row items-center pt-[2rem] sm:pt-[5rem] dark:bg-dark dark:text-slate-200">
      ...
      <div className="lg:w-[55%] flex flex-col items-center self-center text-base font-medium text-justify p-5">
        ...
        <p className="mt-4">
          In my journey, I&apos;ve actively contributed to collaborative teams,
        ...
        <div className="flex mt-10">
          ...
          <Link
            ...
            target="_blank"
            className="flex items-center pt-4 pb-2 px-10 ml-5 bg-black text-light rounded-xl text-xl font-extrabold dark:border dark:border-light"
          >
            <MailIcon />
          </Link>
        </div>
